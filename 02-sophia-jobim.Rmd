...
1. **Proporcoes**: O metodo Sophia Jobim usa divisoes proporcionais baseadas no busto, nao em tabelas prontas. Isso significa que o molde se adapta automaticamente a diferentes tamanhos.
2. **Assimetria frente/costas**: A frente e sempre mais larga que as costas (deslocamento EF de 3 cm). Isso acomoda o busto e da mobilidade aos bracos.
3. **Cava anatomica**: Construida com 7 pontos (P, Z, U, Q, T, Y, M) que controlam a curvatura. As bissetrizes em R (1.5 cm) e S (2.5 cm) sao valores empiricos que funcionam para a maioria dos corpos.
4. **Decote com desvio**: Tanto o decote frente (ponto I2) quanto o decote costas (ponto L2) tem um desvio de 1 cm sobre a linha do ombro. Isso evita que o decote fique pontudo.
5. **Ombro costas com pence**: O ponto O desce 5 cm de K, e a linha LO e prolongada 1 cm para P. Essa pequena pence ajuda a acomodar a escapula.
6. **Barra elevada**: A barra sobe 3 cm a partir de H e C (pontos W e a). Isso evita que a blusa fique comprida demais nas laterais.
